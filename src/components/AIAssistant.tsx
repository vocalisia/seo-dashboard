...
function CopyButton({ text }: { text: string }) {
  ...
  return (
    <button
      type="button"
      onClick={handleCopy}
      className="flex min-h-10 items-center gap-1 rounded bg-gray-700 px-3 text-xs text-gray-400 transition-colors hover:bg-gray-600 hover:text-white"
    >
    ...
    <>
      ...
      {open && (
        <>
          ...
          <aside ref={drawerRef} role="dialog" aria-modal="true" aria-labelledby="ai-assistant-title" className="fixed right-0 top-0 z-50 flex h-dvh w-full flex-col border-l border-gray-800 bg-gray-950 shadow-2xl sm:w-[28rem]">
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
          ...
          <button
            ...
            className="grid h-11 w-11 place-items-center rounded-lg text-gray-400 transition-colors hover:bg-gray-800 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-400"
            aria-label="Fermer"
          >
            <X size={18} />
          </button>
        ...
        <div className="flex overflow-x-auto border-b border-gray-800" role="tablist" aria-label="Actions de l'assistant">
          {TABS.map((tab) => (
            <button
              key={tab.id}
              type="button"
              ...
              className={`min-h-11 flex-1 whitespace-nowrap px-3 py-2 text-xs font-medium transition-colors ${
                activeTab === tab.id
        ...
        <div id="ai-assistant-panel" role="tabpanel" aria-labelledby={`ai-tab-${activeTab}`} className="flex-1 overflow-y-auto p-4 space-y-3">
          {activeTab === "write" && (
            <div className="space-y-3">
              ...
              <button
                ...
                className="flex min-h-11 w-full items-center justify-center gap-2 rounded bg-purple-600 py-2 text-sm font-medium text-white transition-colors hover:bg-purple-500 disabled:opacity-50"
              >
          ...
          {activeTab === "translate" && (
            <div className="space-y-3">
              ...
              <button
                ...
                className="flex min-h-11 w-full items-center justify-center gap-2 rounded bg-blue-600 py-2 text-sm font-medium text-white transition-colors hover:bg-blue-500 disabled:opacity-50"
              >
                {loading ? <Loader2 size={14} className="animate-spin" /> : null}
                Traduire
              </button>
          ...
          {error && (
            <div role="alert" className="bg-red-900/40 border border-red-700 rounded p-3 text-red-300 text-xs">
              {error}
            </div>
          )}
